                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left input_mask">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                            <input type="text" class="form-control has-feedback-left" id="telefone" placeholder="Telefone">
    ...
    $(document).ready(function () {
        ...
        $("#btnCadastrarCategoria").click(function () {
            ...
            function (r) {
                ...
                $("#listaCategorias").append($("#listaCategorias").load('listaCategorias.php'));
        ...
        $("#btnCadFuncionario").click(function () {
            ...
            $.post('control/controleFuncionario.php', {opcao: 'cadastrar', categoria: categorias, nome:nome, telefone:telefone, email:email},
            function (r) {
                console.log(r);
            });
        });
