                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <p class="nav navbar-right panel_toolbox">
                      <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalCadastroServico">Adicionar</button>
                    </p>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <td>Newborn</td>
                          <td>Cliente 1, Cliente 2, Fulano</td>
                          <td></td>
                          <td></td>
                        </tr>
                        <tr>
                          <td>Bodas</td>
                          <td>Fulano, Paulo, Siclano</td>
                          <td></td>
                          <td></td>
                        </tr>
                        <tr>
                          <td>Filmagem</td>
                          <td>Cliente 1, Siclano</td>
                          <td></td>
                          <td></td>
                        </tr>
                      </tbody>
