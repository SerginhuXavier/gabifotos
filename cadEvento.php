  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask">
					  ...
					  <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                        <label class="fa fa-users form-control-feedback left"></label>
                        
                          <select class="select2_single form-control" tabindex="-1">
                            <option></option>
                            <option value="1">Fulano</option>
							<option value="2">Siclano</option>
					  ...
					  <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                        <label class="fa fa-camera-retro form-control-feedback left"></label>
                        
                          <select class="select2_single form-control has-feedback-left" tabindex="-1">
                            <option></option>
                            <option value="1">Newborn</option>
							<option value="2">Bodas</option>
							<option value="3">Filmagem</option>
                          </select>
                      </div>
					  
					  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="dataEvento" placeholder="data do evento">
                        <span class="fa fa-calendar form-control-feedback left" aria-hidden="true"></span>
                      </div>
					  
					  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control" id="dataEnsaio" placeholder="data do ensaio">
                        <span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
                      </div>
					  
					  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="dataFesta" placeholder="data da Festa">
                        <span class="fa fa-calendar form-control-feedback left" aria-hidden="true"></span>
                      </div>
    ...
    <script>
      $(document).ready(function() {
		...
		$('#dataEnsaio').daterangepicker({
          singleDatePicker: true,
          singleClasses: "picker_4"
        }, function(start, end, label) {
          console.log(start.toISOString(), end.toISOString(), label);
        });
		$('#dataFesta').daterangepicker({
          singleDatePicker: true,
          singleClasses: "picker_4"
        }, function(start, end, label) {
          console.log(start.toISOString(), end.toISOString(), label);
